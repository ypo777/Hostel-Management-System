...
{
    $sql = "SELECT PASSWORD FROM ADMIN WHERE ADMIN_ID = ".$_POST['adminID'];
        ...
        <div class="ui middle aligned center aligned gird">
            <div class="column">
                <div class="ui mini modal">
                    ...
                    <div class="actions">
                        <a href="Admin_Login.php" class="ui green ok button">OK</a>
...
<div class="ui middle aligned center aligned grid">
    <div class="column">
        <form class="ui large form" style="max-width: 300px; margin-left: 175px" action="Admin_Login.php" method="post">
